"""  THIS FILE MUST BE IN THE ROOT CKAN FOLDER, NOT IN AN EXTENSION """
# Location should be: src/ckan/ckan/views/api.py
# Keep this modified version in the root CKAN installation, but on a custom branch.
