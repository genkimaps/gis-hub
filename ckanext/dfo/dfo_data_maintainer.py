...
def setup_smtp(dataset_records, message_template):
    ...
    s = smtplib.SMTP(host=os.environ.get('CKAN_SMTP_SERVER'), port=587)
    s.starttls()
    s.login(os.environ.get('CKAN_SMTP_USER'), os.environ.get('CKAN_SMTP_PASSWORD'))
...
parse_csv("F:\\metadata_modified.csv")
